...
class Renderer(object):
    ...
    def transform(self, vertex):
        ...
        tranformed_vertex = customNumpy.dot(customNumpy.dot(customNumpy.dot(customNumpy.dot(self.Viewport, self.Projection), self.View), self.Model), augmented_vertex)
        tranformed_vertex = [
    ...
    def loadModelMatrix(self, translate=(0, 0, 0), scale=(1, 1, 1), rotate=(0, 0, 0)):
        ...
        rotation_matrix = customNumpy.dot(customNumpy.dot(rotation_matrix_x, rotation_matrix_y), rotation_matrix_z)
        ...
        self.Model = customNumpy.dot(customNumpy.dot(translation_matrix, rotation_matrix), scale_matrix)
