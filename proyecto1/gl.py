...
class Renderer(object):
    ...
    def transform(self, vertex):
        ...
        tranformed_vertex = dot(dot(dot(dot(self.Viewport, self.Projection), self.View), self.Model), augmented_vertex)
        tranformed_vertex = [
    ...
    def loadModelMatrix(self, translate=(0, 0, 0), scale=(1, 1, 1), rotate=(0, 0, 0)):
        ...
        rotation_matrix = dot(dot(rotation_matrix_x, rotation_matrix_y), rotation_matrix_z)
        ...
        self.Model = dot(dot(translation_matrix, rotation_matrix), scale_matrix)
